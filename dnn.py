...
while curFrame < NFRAMES:
    ...
    # Your code here in this if condition -- The if condition is used to sample every 4 data for sending.
    if count % 4 == 0:
        deg_bytes = bytes(str(deg), 'utf-8')
    ...
    print('pred: {:0.2f} deg. took: {:0.2f} ms | cam={:0.2f} prep={:0.2f} pred={:0.2f}'.format(deg, tot_time,
                                                                                                cam_time, prep_time,
                                                                                                pred_time))
